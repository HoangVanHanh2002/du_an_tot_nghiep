                        ...
                        @foreach($permissions ?? [] as $item)
                            <tr>
                                ...
                                <td scope="row">
                                    ...
                                    <a href="{{ route('get_admin.permission.update', $item->id) }}" class="text-blue"><button type="button" class="btn btn-primary">Edit</button></a>
                                    <a href="{{ route('get_admin.permission.delete', $item->id) }}" class="text-danger"><button type="button" class="btn btn-danger">Delete</button></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
